module.exports = {
    ...
    get: {
        ...
        description: "Get user's following", // operation's desc.
        operationId: "getFollowing", // unique operation id.
        parameters: [
            // expected params.
            {
        ...
        responses: {
            ...
            200: {
                description: "Users can retrieve the list of followings by a specific ID", // response desc.
                content: {
                    // content-type
                    "application/json": {
                        schema: {
